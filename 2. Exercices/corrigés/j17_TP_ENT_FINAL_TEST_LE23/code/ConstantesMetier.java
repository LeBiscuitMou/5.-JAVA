package net.ent.etrs.pjjeudesociete.models.entities.references;
...
public final class ConstantesMetier {
    ...
    public static final String JDS_NB_JOUEUR_INCORRECT = "Le nombre de joueur ne peut pas être inférieur à ;
    public static final String JDS_PRIX_INCORRECT = "Le prix du jeu de société ne peujt pas être inférieur à;
