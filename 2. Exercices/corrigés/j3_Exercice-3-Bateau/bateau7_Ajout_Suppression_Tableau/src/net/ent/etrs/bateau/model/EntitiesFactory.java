...
public final class EntitiesFactory {
    ...
    //Fregate
    public static Bateau fabriquerFregate(String nom, int nbEquipage, float tonnage, String moyenpropulsion, Helico helicoptere) throws FactoryException {
        try {
    ...
    //PA
    public static  Bateau fabriquerPorteAvion(String nom, int nbEquipage, float tonnage, String moyenpropulsion) throws FactoryException {
        try {
