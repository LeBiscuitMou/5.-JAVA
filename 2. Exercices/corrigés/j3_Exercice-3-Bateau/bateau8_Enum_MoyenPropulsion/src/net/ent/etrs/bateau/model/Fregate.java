...
public class Fregate extends Bateau{
    ...
    protected Fregate(String nom, int nbEquipage, float tonnage, MoyenPropulsion moyenpropulsion) throws BateauException {
    ...
    public void setMoyenPropulsion(MoyenPropulsion moyenPropulsion) {
       MoyenPropulsion m = MoyenPropulsion.valueOf("PETROLE");
