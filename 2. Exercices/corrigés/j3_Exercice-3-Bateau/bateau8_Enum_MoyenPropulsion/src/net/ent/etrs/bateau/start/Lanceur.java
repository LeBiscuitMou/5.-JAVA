...
import net.ent.etrs.bateau.model.*;
...
public class Lanceur {
    public static void main(String[] args) {
        ...
        try {
            Fregate f = (Fregate) EntitiesFactory.fabriquerFregate("TEST",500,50000F, MoyenPropulsion.PETROLE,EntitiesFactory.fabriquerHelico("HMA-GAZELLE"));
