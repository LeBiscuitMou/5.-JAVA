...
public final class ConstanteMetier {
    ...
    public static final String JDS_NB_JOUEUR_INCORRECT = String.format("Le nombre de joueur ne peut pas être inférieur à %d", 0);
    public static final String JDS_PRIX_INCORRECT = "Le prix du jeu de société ne peujt pas être inférieur à 8.0";
