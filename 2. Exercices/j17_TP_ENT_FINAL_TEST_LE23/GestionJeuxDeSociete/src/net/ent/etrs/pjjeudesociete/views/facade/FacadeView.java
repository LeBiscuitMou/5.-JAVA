...
public interface FacadeView {
     ...
     */
    JeuSociete saisirJeuSociete(Set<Auteur> lesAuteursPossible, Set<MaisonEdition> lesMAisonEditions) throws FacadeViewException;
     ...
     */
    Auteur saisirAuteur() throws FacadeViewException;
     ...
     */
    JeuSociete modifierJeuSociete(JeuSociete jds) throws FacadeViewException;
     ...
     */
    MaisonEdition saisirMaisonEdition() throws FacadeViewException;
}
