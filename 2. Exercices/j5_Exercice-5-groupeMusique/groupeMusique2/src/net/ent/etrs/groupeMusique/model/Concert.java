...
public class Concert {
    ...
    private void setTypeConcert(TypeConcert typeConcert) throws ConcertException {
        if(Objects.isNull(typeConcert)){
            throw new ConcertException(ConstantesMetier.CONCERT_TYPE_CONCERT_NULL);
        }
        this.typeConcert = typeConcert;
    }

    private void setLieu(Lieu lieu) throws ConcertException {
        if(Objects.isNull(lieu)){
            throw new ConcertException(ConstantesMetier.CONCERT_ERROR_LIEU_NULL);
        }
        this.lieu = lieu;
    }
