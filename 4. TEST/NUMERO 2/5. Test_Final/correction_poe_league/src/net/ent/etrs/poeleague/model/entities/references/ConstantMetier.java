...
public final class ConstantMetier {
    ...
    public static final int LEAGUE_NOM_MINIMUM_CARACTERE = 5;
    public static final String LEAGUE_NOM_TAILLE_INCORRECT = "le nom de la league doit être au minimum de " + LEAGUE_NOM_MINIMUM_CARACTERE;
